...
import { Calendar, Tag, ShieldCheck, Award, Zap, Trophy } from 'lucide-react';
             ...
             <div className="absolute inset-0 bg-[#1A1A1A] rounded-[2.5rem] p-8 border border-white/10 shadow-2xl flex flex-col justify-between overflow-hidden">
                   ...
                   <div>
                      <div className="flex items-center gap-2 mb-3">
                         <span className="bg-orange-500 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full shadow-lg shadow-orange-500/20">
                            {promotion.promotionType || 'Loyalty'}
                         </span>
                      </div>
                ...
                <div className="flex items-end justify-between mt-auto z-10">
                   ...
                   <Button 
                    ...
                    disabled={participateMutation.isPending || !!isFuturePromotion}
                    className="h-14 px-10 bg-white text-black hover:bg-[#f58220] hover:text-white font-black text-xs uppercase tracking-widest rounded-2xl transition-all shadow-xl shadow-black/20 disabled:opacity-50"
                   >
                    {isFuturePromotion ? 'Coming Soon' : participateMutation.isPending ? 'Joining...' : 'Join Program'}
                   </Button>
                </div>
