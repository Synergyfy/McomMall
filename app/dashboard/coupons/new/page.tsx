                ...
                <div className="flex items-center gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>The code customers will enter at checkout.</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>A short description for this coupon.</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          Upload an image to display in the coupon widget.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Percentage-based or a fixed amount discount.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>The date this coupon will expire.</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            The maximum amount that can be spent for the
                            coupon to be valid.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            The products that this coupon can be applied to.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          A comma-separated list of email addresses that can
                          use this coupon.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>
                          The maximum number of times a single user can use
                          this coupon.
                        </p>
                      </TooltipContent>
                    </Tooltip>
