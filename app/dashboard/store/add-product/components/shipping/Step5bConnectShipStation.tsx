        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="mx-4 p-6 md:p-8 rounded-xl bg-gradient-to-br from-white to-[#fff8f2] dark:from-[#2c2219] dark:to-[#2e231b] border border-[#e8dbce] dark:border-[#4a3b2f] shadow-sm relative overflow-hidden group">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
                    ...
                    <button className="whitespace-nowrap flex items-center justify-center rounded-lg h-10 px-5 bg-white dark:bg-transparent dark:border dark:border-[#f48c25] text-[#f48c25] border border-[#f48c25]/20 hover:bg-[#f48c25] hover:text-white transition-all duration-200 text-sm font-bold shadow-sm">
                        Create ShipStation Account
                        <span className="material-symbols-outlined text-lg ml-2">open_in_new</span>
                    </button>
                </div>
            </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[#1c140d] dark:text-white text-sm font-semibold flex items-center gap-2" htmlFor="api-key">
                            API Key
                            <span className="material-symbols-outlined text-[16px] text-[#9c7349] dark:text-gray-500 cursor-help" title="Your unique API identifier">help</span>
                        </label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <span className="material-symbols-outlined text-[#9c7349] dark:text-gray-500">key</span>
                            </div>
                            <input
                                id="api-key"
                                type="password"
                            ...
                            />
                            <button className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#9c7349] dark:text-gray-500 hover:text-[#f48c25] transition-colors">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[#1c140d] dark:text-white text-sm font-semibold flex items-center gap-2" htmlFor="api-secret">
                            API Secret
                            <span className="material-symbols-outlined text-[16px] text-[#9c7349] dark:text-gray-500 cursor-help" title="Your confidential API secret">help</span>
                        </label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <span className="material-symbols-outlined text-[#9c7349] dark:text-gray-500">lock</span>
                            </div>
                            <input
                                id="api-secret"
                                type="password"
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800/30 w-fit">
                                <span className="material-symbols-outlined text-red-600 dark:text-red-400 text-[18px]">link_off</span>
                        ...
                        <div className="flex items-center gap-4 flex-1 justify-end mt-2 sm:mt-0">
                            <button onClick={onBack} className="px-6 py-3 rounded-lg text-[#1c140d] dark:text-white font-bold hover:bg-gray-100 dark:hover:bg-white/5 transition-colors text-sm">
                                Back
                            </button>
                            <button onClick={onNext} className="flex items-center justify-center gap-2 px-8 py-3 rounded-lg bg-[#f48c25] hover:bg-[#f48c25]/90 text-white shadow-md shadow-[#f48c25]/20 transition-all text-sm font-bold min-w-[180px]">
