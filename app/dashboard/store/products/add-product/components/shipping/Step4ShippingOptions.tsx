  ...
  return (
    <div className="flex flex-col max-w-5xl mx-auto px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
        ...
        {/* Card 2: ShipStation */}
        <div 
          className="group relative flex flex-col rounded-2xl border-2 border-transparent bg-white dark:bg-[#2d241b] p-8 shadow-sm ring-2 ring-[#e8dbce] dark:ring-[#4a3b2e] pointer-events-none grayscale opacity-60"
        >
          {/* Coming Soon Overlay */}
          <div className="absolute inset-0 z-10 flex items-center justify-center">
            <span className="bg-gray-800 text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg transform rotate-2">Coming Soon</span>
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <ShieldCheck className="text-[#f48c25]/40" size={24} />
          </div>
          ...
          <div className="mt-8 flex items-center gap-2 bg-[#f48c25] text-white w-fit px-6 py-2 rounded-xl font-bold text-sm shadow-md">
