...
const MemberCard = ({ member, isFounder }: { member: GroupMember, isFounder: boolean }) => (
  <div className="flex items-center justify-between p-4 border rounded-lg bg-white dark:bg-gray-800/50">
    <div className="flex items-center">
      ...
      <div>
        ...
        {isFounder && (
            <Badge variant="secondary" className="ml-2 border-amber-500/50 bg-amber-50 text-amber-700">
