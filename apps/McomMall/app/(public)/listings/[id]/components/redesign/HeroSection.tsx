...
export default function HeroSection({ listing }: HeroSectionProps) {
  return (
    <div className="relative h-[60vh] min-h-[500px] w-full bg-[#1A1A1A] overflow-hidden">
      ...
      >
        <img src={listing.bannerUrl || 'https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&w=1920&q=80'} alt={listing.bannerAltText || listing.businessName} className="absolute inset-0 w-full h-full object-cover opacity-60" />
            ...
            >
              <div className="w-32 h-32 md:w-44 md:h-44 rounded-[2.5rem] bg-white p-2 shadow-2xl border-4 border-white overflow-hidden">
                <div className="relative w-full h-full rounded-[2rem] overflow-hidden bg-gray-50">
                   <img src={listing.logoUrl || 'https://via.placeholder.com/200?text=Logo'} alt={listing.logoAltText || listing.businessName} className="absolute inset-0 w-full h-full object-cover" />
                </div>
              </div>
