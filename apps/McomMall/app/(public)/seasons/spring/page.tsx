  ...
  return (
    <div className="bg-emerald-950 text-stone-100 font-sans">
        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://247-gbs-expo.vercel.app/events/national" target="_blank">
              <Button
                size="lg"
                className="bg-pink-500 hover:bg-pink-600 text-white font-bold text-lg px-8 py-6 w-full"
              >
            ...
            <Link href="https://247-gbs-expo.vercel.app/events/national" target="_blank">
              <Button
                size="lg"
                variant="outline"
                className="text-white border-pink-400 bg-transparent hover:bg-white hover:text-pink-700 transition-colors duration-300 font-bold text-lg px-8 py-6 w-full"
              >
      ...
      <section className="relative py-24 px-6 text-center">
        <img
          src="https://source.unsplash.com/random/1920x1080/?spring,flowers,blossom"
          alt="Spring flowers landscape"
