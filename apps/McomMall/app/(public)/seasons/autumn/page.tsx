// app/autumn-exhibition/page.tsx
...
// --- Animated Leaves Overlay Component ---
const FallingLeaves = () => {
  const leafColors = [
    'bg-orange-500/70',
    'bg-yellow-400/70',
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-10">
      {Array.from({ length: 100 }).map((_, i) => {
        ...
        const finalX = initialX + (Math.random() - 0.5) * 20; // Drifting effect
        ...
        return (
          <motion.div
            ...
            animate={{
              y: '110vh',
              x: `${finalX}vw`,
              rotate: Math.random() * 720, // Tumble effect
              opacity: [0, 1, 1, 0],
            }}
            transition={{
              duration,
...
// --- Main Page Component ---
export default function AutumnExhibitionPage() {
  ...
  const offeringCards = [
    {
      icon: Gift,
      title: 'Harvest Promotions',
      description: 'Curated deals and seasonal sales.',
    },
    {
      icon: Ticket,
  ...
  const businessBenefits = [
    {
      ...
      text: 'Get featured in our Autumn hub with thousands of consumers.',
    },
    {
      icon: Rocket,
      title: 'Drive Sales',
    ...
    },
    {
      icon: Wand2,
      title: 'Easy Setup',
      text: 'Use ready-made autumn templates & tools to go live in minutes.',
    },
  ];
  ...
  const consumerSteps = [
    ...
    {
      icon: LayoutGrid,
      title: 'Browse Autumn Marketplace',
  ...
  return (
    <div className="bg-zinc-900 text-zinc-100 font-sans">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center text-center overflow-hidden">
        <img src="https://images.unsplash.com/photo-1509838174235-432f709c7bfd?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Autumn city lights at night" className="absolute inset-0 w-full h-full object-cover z-0 opacity-50" />
        <FallingLeaves />
        ...
        >
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-white drop-shadow-lg">
            Autumn Virtual Exhibition
          </h1>
          <p className="mt-4 max-w-3xl mx-auto text-lg md:text-xl text-zinc-200 drop-shadow-md">
            Celebrate the harvest season with exclusive offers, cozy events, and
      ...
      <section className="py-20 px-6 md:px-12 bg-zinc-900">
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              What the Autumn Exhibition Means
            </motion.h2>
            <motion.div
              variants={itemVariants}
              className="space-y-4 text-zinc-300 text-lg leading-relaxed"
            >
              <p>
                Autumn is a season of gathering. Our Virtual Exhibition brings
                together businesses and consumers in a vibrant digital
                marketplace, designed to highlight exclusive offers and seasonal
                campaigns that make the crisp days cozier.
              </p>
              <p>
                Think of it as your online harvest festival, where businesses
                can showcase their best promotions, and you can discover, shop,
                and engage — all from the comfort of home.
              </p>
            </motion.div>
            ...
            <motion.p
              variants={itemVariants}
              className="mt-10 text-xl font-bold italic text-amber-400"
            >
              “Your autumn, your marketplace — always online, always rewarding.”
            </motion.p>
          </motion.div>
          <motion.div
          ...
          >
            <img src="https://images.unsplash.com/photo-1731316392480-292c584d943e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Digital marketplace illustration" width={800} height={600} />
          </motion.div>
        </div>
      </section>

      {/* 3. What We're Offering Section */}
      <section className="py-20 px-6 md:px-12 bg-zinc-800/50">
          ...
          >
            {offeringCards.map((card, index) => (
              <motion.div key={index} variants={itemVariants}>
                <Card className="bg-zinc-800 border-amber-700/50 text-white h-full hover:border-amber-500 hover:scale-105 transition-all duration-300">
                  <CardHeader className="items-center">
                    <div className="p-4 bg-zinc-700 rounded-full mb-4">
                      <card.icon className="w-8 h-8 text-orange-400" />
                    </div>
          ...
          <div className="mt-16">
            ...
            <div className="w-full max-w-4xl mx-auto">
              <Carousel>
                  ...
                  {pastExhibitions.map((exhibition, index) => (
                    <CarouselItem key={index}>
                      <div className="aspect-video p-1">
                        <iframe
                          className="w-full h-full rounded-lg border border-amber-800/50"
                ...
                <CarouselPrevious className="text-white bg-zinc-700/80 border-amber-600 hover:bg-zinc-600" />
                <CarouselNext className="text-white bg-zinc-700/80 border-amber-600 hover:bg-zinc-600" />
              </Carousel>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto text-center">
          ...
          >
            {businessBenefits.map((benefit, index) => (
              <motion.div key={index} variants={itemVariants}>
                <Card className="bg-zinc-800 border-amber-700/50 text-white h-full text-center hover:border-amber-500 hover:scale-105 transition-all duration-300 flex flex-col items-center p-6">
                  <CardHeader className="p-0 mb-4">
                    <div className="p-5 bg-zinc-700 rounded-full">
      ...
      <section className="py-20 px-6 md:px-12 bg-zinc-800/50">
        <div className="container mx-auto">
          ...
          >
                    ...
                    <Card className="relative overflow-hidden bg-stone-100 text-zinc-900 border-orange-200 h-[400px] group">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 z-10 bg-gradient-to-t from-amber-800/90 to-amber-600/20 transition-all duration-500 ease-in-out h-1/2 group-hover:h-full flex flex-col justify-end">
                        <div className="flex items-center gap-3 mb-2">
                          <benefit.icon className="w-8 h-8 text-amber-100" />
                          <h3 className="text-2xl font-bold text-white leading-tight">
                            {benefit.title}
                          </h3>
                        </div>
                        <div className="overflow-hidden max-h-0 group-hover:max-h-40 transition-all duration-500 ease-in-out">
                          <p className="text-amber-100 text-sm mt-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200">
                            {benefit.text}
                          </p>
                          <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-300">
                            <Button
                              size="sm"
                              className="bg-amber-200 text-amber-800 hover:bg-white"
                            >
                              Learn More
                            </Button>
                          </div>
            ...
            <CarouselPrevious className="text-white bg-zinc-700 border-amber-600 hover:bg-zinc-600" />
            <CarouselNext className="text-white bg-zinc-700 border-amber-600 hover:bg-zinc-600" />
          </Carousel>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 bg-zinc-900">
        <div className="container mx-auto">
          ...
          <div className="relative max-w-2xl mx-auto">
            <div className="absolute left-6 md:left-1/2 top-0 h-full w-1 bg-amber-800/50 transform md:-translate-x-1/2"></div>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute left-6 md:left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                    <div className="flex items-center justify-center w-12 h-12 bg-zinc-800 border-2 border-orange-500 rounded-full">
                      <step.icon className="w-6 h-6 text-orange-400" />
                    </div>
                  </div>
                  <div className="w-full md:w-5/12 p-6 bg-zinc-800 rounded-lg border border-amber-800/50">
            ...
            {consumerSteps.map((step, index) => (
              ...
              >
                <div className="relative mb-4">
                  <step.icon className="w-16 h-16 text-orange-400" />
                  <div className="absolute -top-2 -right-2 flex items-center justify-center w-8 h-8 bg-orange-500 rounded-full font-bold text-white border-2 border-zinc-800">
                    {index + 1}
                  </div>
                </div>
      ...
      <section className="relative py-24 px-6 text-center">
        <img src="https://source.unsplash.com/random/1920x1080/?autumn,fall,leaves" alt="Autumn fall landscape" className="absolute inset-0 w-full h-full object-cover z-0 opacity-40" />
