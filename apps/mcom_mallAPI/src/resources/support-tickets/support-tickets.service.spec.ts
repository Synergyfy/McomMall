...
describe('SupportTicketsService', () => {
  ...
  describe('createTicket', () => {
    it('should create a ticket and an initial message', async () => {
      ...
      expect((service as any).ticketRepo.create).toHaveBeenCalled();
      expect((service as any).ticketRepo.save).toHaveBeenCalled();
      expect((service as any).messageRepo.create).toHaveBeenCalledWith(
  ...
  describe('addMessage', () => {
    ...
    it('should allow admin to add a message and update status', async () => {
      ...
      ((service as any).ticketRepo.findOne as jest.Mock).mockResolvedValue({
        ...mockTicket,
        status: TicketStatus.OPEN,
      });
      ...
      expect((service as any).ticketRepo.save).toHaveBeenCalledWith(
        expect.objectContaining({
  ...
  describe('findAll', () => {
    it('should return user tickets for customer', async () => {
      ...
      expect((service as any).ticketRepo.find).toHaveBeenCalledWith(
        expect.objectContaining({
