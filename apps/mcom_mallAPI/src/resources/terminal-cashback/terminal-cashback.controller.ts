...
export class TerminalCashbackController {
  ...
  @ApiResponse({
    ...
    type: TerminalCashbackClaim,
  })
  async createClaim(
    @CurrentUser() user: any,
    @Body() dto: CreateTerminalCashbackClaimDto,
  ) {
  ...
  async updateStatus(
    @Param('id') id: string,
    @Body() dto: UpdateTerminalCashbackStatusDto,
  ) {
  ...
  @ApiResponse({
    ...
    schema: {
      example: { pendingCount: 2, approvedCount: 15, totalEarned: 45.5 },
    },
  })
  ...
  async updateConfig(
    ...
    @Body() dto: UpdateTerminalConfigDto,
  ) {
