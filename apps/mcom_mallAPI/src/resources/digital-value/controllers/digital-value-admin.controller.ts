...
export class DigitalValueAdminController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Get all digital value instruments',
    description: 'Retrieves all instruments across the platform for auditing.',
  })
  ...
  @Post()
  @ApiOperation({
    summary: 'Create a new digital value instrument',
    description:
      'Admin endpoint to issue new gift cards or vouchers directly (e.g., for customer support or manual rewards).',
  })
