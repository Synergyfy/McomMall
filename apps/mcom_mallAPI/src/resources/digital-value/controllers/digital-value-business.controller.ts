...
export class DigitalValueBusinessController {
  ...
  @ApiOperation({
    summary: 'Get instruments linked to this merchant',
    description:
      'Retrieves all instruments that have been explicitly linked to this merchant.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves history of redemptions and activities for merchant-linked instruments.',
  })
  ...
  @ApiOperation({
    summary: 'Redeem a customer instrument at this merchant',
    description:
      "Processes a payment using a customer's digital value instrument. Checks balance and merchant validity.",
  })
  @ApiResponse({
    status: 200,
    description: 'Redemption successful. Returns updated instrument.',
  })
  @ApiResponse({
    status: 400,
    description: 'Insufficient balance or invalid merchant.',
  })
