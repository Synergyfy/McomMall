...
describe('DigitalValueService', () => {
  ...
  beforeEach(async () => {
    ...
    // IMPORTANT: When queryRunner is returned, its manager property must be accessible
    ...
    transactionRepository = module.get(
      getRepositoryToken(DigitalValueTransaction),
    );
  ...
  describe('create', () => {
    it('should create a digital value instrument', async () => {
      ...
      jest
        .spyOn(digitalValueRepository, 'create')
        .mockReturnValue({ ...createDto, code: 'CODE123' } as any);
