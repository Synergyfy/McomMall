    ...
    return {
      ...
      topContributors: [
        ...
        },
        {
          ...
          score: 94,
          avatarUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAdD2g432RjYg_Q7J167xO2s1219L6K4M3o1O9_sH3X_D222tM321_H123... (placeholder or actual)',
        },
        {
          rank: 3,
          name: 'Urban Threads',
      ...
      heatmapOverlays: [
        ...
        { name: 'Shops Ready', type: 'count', value: 12, lat: 51.5342, lng: -0.1065 },
      ]
    };
  }
}
