...
export class CreateProductVariantTemplateDto {
  ...
  @ApiPropertyOptional({ description: 'The category this template applies to', example: 'Clothing' })
  @IsOptional()
  @IsString()
  category?: string;

  @ApiPropertyOptional({ description: 'The sub-category this template applies to', example: 'T-Shirts' })
  @IsOptional()
  @IsString()
  subCategory?: string;
