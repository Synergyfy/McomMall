...
export class DashboardStatsDto {
  ...
  @ApiProperty({
    example: 156,
    description: 'Number of new signups in the last 24 hours',
  })
  ...
  @ApiProperty({ example: 45892.5, description: 'Total revenue today' })
  revenueToday: number;
...
export class AnalyticsDataDto {
  ...
  @ApiProperty({ example: 312456.9, description: 'Total revenue this week' })
...
export class ActivityItemDto {
  @ApiProperty({
    example: 'user',
    description: 'Type of activity (user, order, business)',
  })
  type: string;

  @ApiProperty({
    example: 'New user joined: John Doe',
