...
export class CreateCouponDto {
  ...
  @ApiProperty({
    description: 'Discount value (Fixed or Percentage)',
    example: 10,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    description:
      'Total number of times this coupon can be redeemed (0 = unlimited)',
    example: 100,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Number of times a single user can redeem this coupon',
    example: 1,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Date when the coupon becomes valid',
    type: Date,
  })
  @IsOptional()
  startDate?: Date;
  ...
  @ApiPropertyOptional({
    description:
      'Associated Marketing Campaign ID (Required for Platform coupons)',
    format: 'uuid',
  })
  @IsUUID()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Associated Business ID (Required for Business coupons)',
    format: 'uuid',
  })
  @IsUUID()
  @IsOptional()
