...
export class CreateDisputesTable1768176274686 implements MigrationInterface {
  name = 'CreateDisputesTable1768176274686';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."disputes_reason_enum" AS ENUM('not_received', 'not_as_described', 'defective', 'wrong_item', 'seller_unresponsive', 'other')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."disputes_status_enum" AS ENUM('new', 'under_review', 'mediated', 'resolved', 'escalated')`,
    );
    await queryRunner.query(
      `CREATE TABLE "disputes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "customerId" uuid NOT NULL, "businessId" uuid NOT NULL, "orderId" uuid, "amount" numeric(10,2) NOT NULL, "reason" "public"."disputes_reason_enum" NOT NULL, "description" text NOT NULL, "evidence" text, "status" "public"."disputes_status_enum" NOT NULL DEFAULT 'new', "resolutionNotes" character varying, "resolvedBy" character varying, "resolutionDecision" character varying, CONSTRAINT "PK_3c97580d01c1a4b0b345c42a107" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "disputes" ADD CONSTRAINT "FK_4973306692b39c7e6084a8ac546" FOREIGN KEY ("customerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "disputes" ADD CONSTRAINT "FK_f3ce8bf626bc8bdc43ef92f9056" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "disputes" ADD CONSTRAINT "FK_8acbc1c3c0ba479dd4010eeb46a" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "disputes" DROP CONSTRAINT "FK_8acbc1c3c0ba479dd4010eeb46a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "disputes" DROP CONSTRAINT "FK_f3ce8bf626bc8bdc43ef92f9056"`,
    );
    await queryRunner.query(
      `ALTER TABLE "disputes" DROP CONSTRAINT "FK_4973306692b39c7e6084a8ac546"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_81d38487c29d69bf340eead614c"`,
    );
