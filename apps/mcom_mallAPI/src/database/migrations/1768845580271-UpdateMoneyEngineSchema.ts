...
export class UpdateMoneyEngineSchema1768845580271 implements MigrationInterface {
  name = 'UpdateMoneyEngineSchema1768845580271';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "reward_definitions" ADD "isActive" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_money_vouchers" ADD "code" character varying(12) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_money_vouchers" ADD CONSTRAINT "UQ_fdf995d496f9d4984f2b4cf8a57" UNIQUE ("code")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_money_vouchers" DROP CONSTRAINT "UQ_fdf995d496f9d4984f2b4cf8a57"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_money_vouchers" DROP COLUMN "code"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reward_definitions" DROP COLUMN "isActive"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
