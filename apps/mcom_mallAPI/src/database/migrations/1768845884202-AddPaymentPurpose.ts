...
export class AddPaymentPurpose1768845884202 implements MigrationInterface {
  name = 'AddPaymentPurpose1768845884202';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payment_histories_purpose_enum" AS ENUM('MEMBERSHIP', 'VOUCHER_PURCHASE', 'PAYG_TOPUP')`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_histories" ADD "purpose" "public"."payment_histories_purpose_enum" NOT NULL DEFAULT 'MEMBERSHIP'`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_histories" ALTER COLUMN "planType" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payment_histories" ALTER COLUMN "planType" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "payment_histories" DROP COLUMN "purpose"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."payment_histories_purpose_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
