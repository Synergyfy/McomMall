...
export class AddFeaturedAndStatusToListings1768174327067 implements MigrationInterface {
  name = 'AddFeaturedAndStatusToListings1768174327067';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "services" ADD "status" character varying NOT NULL DEFAULT 'published'`,
    );
    await queryRunner.query(
      `ALTER TABLE "services" ADD "isFeatured" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "services" DROP COLUMN "isFeatured"`);
