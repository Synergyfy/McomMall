...
export class AddStaffCountToBooking1772384700977 implements MigrationInterface {
  name = 'AddStaffCountToBooking1772384700977';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "numberOfStaff" integer NOT NULL DEFAULT '1'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "numberOfStaff"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
