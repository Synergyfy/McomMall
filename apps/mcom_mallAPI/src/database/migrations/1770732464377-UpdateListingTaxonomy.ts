...
export class UpdateListingTaxonomy1770732464377 implements MigrationInterface {
  name = 'UpdateListingTaxonomy1770732464377';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "businesses" ADD "sectorId" uuid`);
    await queryRunner.query(`ALTER TABLE "businesses" ADD "categoryId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD "subCategoryId" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD CONSTRAINT "FK_627775010550aa1a217aa315147" FOREIGN KEY ("sectorId") REFERENCES "sectors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD CONSTRAINT "FK_4d7c89efebdcbe7f54e92f5eed8" FOREIGN KEY ("categoryId") REFERENCES "taxonomy_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD CONSTRAINT "FK_4649a63b4c7b4b67f5850f01536" FOREIGN KEY ("subCategoryId") REFERENCES "taxonomy_subcategories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP CONSTRAINT "FK_4649a63b4c7b4b67f5850f01536"`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP CONSTRAINT "FK_4d7c89efebdcbe7f54e92f5eed8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP CONSTRAINT "FK_627775010550aa1a217aa315147"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_f143f396ea55404f8ed5a5421a3"`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "businesses" DROP COLUMN "sectorId"`);
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
    await queryRunner.query(
