...
export class UpdateReviewEntity1770605115019 implements MigrationInterface {
  name = 'UpdateReviewEntity1770605115019';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."reviews_status_enum" AS ENUM('pending', 'published')`,
    );
    await queryRunner.query(
