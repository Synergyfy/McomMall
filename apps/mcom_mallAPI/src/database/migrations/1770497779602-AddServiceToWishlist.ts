...
export class AddServiceToWishlist1770497779602 implements MigrationInterface {
  name = 'AddServiceToWishlist1770497779602';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "wishlist_items" ADD "serviceId" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "wishlist_items" ADD CONSTRAINT "FK_07a5faf0ab8d247b0c94da3b22d" FOREIGN KEY ("serviceId") REFERENCES "services"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "wishlist_items" DROP CONSTRAINT "FK_07a5faf0ab8d247b0c94da3b22d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_81d38487c29d69bf340eead614c"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "wishlist_items" DROP COLUMN "serviceId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
