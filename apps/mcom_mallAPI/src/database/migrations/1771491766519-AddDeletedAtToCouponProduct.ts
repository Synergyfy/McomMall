...
export class AddDeletedAtToCouponProduct1771491766519 implements MigrationInterface {
  name = 'AddDeletedAtToCouponProduct1771491766519';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "coupon_products" ADD "deletedAt" TIMESTAMP`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "coupon_products" DROP COLUMN "deletedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
