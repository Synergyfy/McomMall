...
export class AddIsVerifiedToBusiness1768173659464 implements MigrationInterface {
  name = 'AddIsVerifiedToBusiness1768173659464';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD "isVerified" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP COLUMN "isVerified"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
