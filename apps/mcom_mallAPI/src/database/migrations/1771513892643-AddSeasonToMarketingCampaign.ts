...
export class AddSeasonToMarketingCampaign1771513892643 implements MigrationInterface {
  name = 'AddSeasonToMarketingCampaign1771513892643';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "marketing_campaigns" ADD "seasonId" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "marketing_campaigns" ADD CONSTRAINT "FK_81c1f029b414830623e96e03bfb" FOREIGN KEY ("seasonId") REFERENCES "seasons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "marketing_campaigns" DROP CONSTRAINT "FK_81c1f029b414830623e96e03bfb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_f143f396ea55404f8ed5a5421a3"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "marketing_campaigns" DROP COLUMN "seasonId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
