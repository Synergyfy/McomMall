...
export class UpdateServiceSchemaAndTaxonomyV51770599303140 implements MigrationInterface {
  name = 'UpdateServiceSchemaAndTaxonomyV51770599303140';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "services" ALTER COLUMN "requireApproval" SET DEFAULT true`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "services" ALTER COLUMN "requireApproval" SET DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
