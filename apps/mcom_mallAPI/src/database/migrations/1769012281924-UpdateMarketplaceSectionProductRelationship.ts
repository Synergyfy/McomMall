...
export class UpdateMarketplaceSectionProductRelationship1769012281924 implements MigrationInterface {
  name = 'UpdateMarketplaceSectionProductRelationship1769012281924';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "marketplace_section_products" ("sectionId" uuid NOT NULL, "productId" uuid NOT NULL, CONSTRAINT "PK_ac699bf94ab782a903771aeb145" PRIMARY KEY ("sectionId", "productId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a94261413dc68f3e507d208505" ON "marketplace_section_products" ("sectionId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_09bff7ea682b39af3ae1f73ba2" ON "marketplace_section_products" ("productId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "marketplace_sections" DROP COLUMN "productIds"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "marketplace_section_products" ADD CONSTRAINT "FK_a94261413dc68f3e507d2085053" FOREIGN KEY ("sectionId") REFERENCES "marketplace_sections"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "marketplace_section_products" ADD CONSTRAINT "FK_09bff7ea682b39af3ae1f73ba2b" FOREIGN KEY ("productId") REFERENCES "Products"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "marketplace_section_products" DROP CONSTRAINT "FK_09bff7ea682b39af3ae1f73ba2b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "marketplace_section_products" DROP CONSTRAINT "FK_a94261413dc68f3e507d2085053"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_81d38487c29d69bf340eead614c"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "marketplace_sections" ADD "productIds" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" ADD "insuranceProvider" character varying`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_09bff7ea682b39af3ae1f73ba2"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a94261413dc68f3e507d208505"`,
    );
    await queryRunner.query(`DROP TABLE "marketplace_section_products"`);
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" ADD CONSTRAINT "FK_f143f396ea55404f8ed5a5421a3" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
