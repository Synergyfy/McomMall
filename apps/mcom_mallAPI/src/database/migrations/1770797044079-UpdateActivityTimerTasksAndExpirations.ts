...
export class UpdateActivityTimerTasksAndExpirations1770797044079 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."help_requests_type_enum" RENAME TO "help_requests_type_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."help_requests_type_enum" AS ENUM('PRODUCT_CREATION', 'PRODUCT_EDIT', 'PRODUCT_VARIATION_SETUP', 'INVENTORY_MANAGEMENT', 'ORDER_PROCESSING', 'STORE_DESIGN', 'PROMOTION_SETUP', 'CUSTOMER_SERVICE_HELP', 'TERMINAL_CASHBACK_SETUP', 'GENERAL_SUPPORT')`,
    );
    await queryRunner.query(
      `ALTER TABLE "help_requests" ALTER COLUMN "type" TYPE "public"."help_requests_type_enum" USING "type"::"text"::"public"."help_requests_type_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."help_requests_type_enum_old" AS ENUM('PRODUCT_CREATION', 'PRODUCT_EDIT', 'PRODUCT_VARIATION_SETUP', 'INVENTORY_MANAGEMENT', 'ORDER_PROCESSING', 'STORE_DESIGN', 'PROMOTION_SETUP', 'CUSTOMER_SERVICE_HELP', 'GENERAL_SUPPORT')`,
    );
    await queryRunner.query(
      `ALTER TABLE "help_requests" ALTER COLUMN "type" TYPE "public"."help_requests_type_enum_old" USING "type"::"text"::"public"."help_requests_type_enum_old"`,
    );
    await queryRunner.query(`DROP TYPE "public"."help_requests_type_enum"`);
    await queryRunner.query(
      `ALTER TYPE "public"."help_requests_type_enum_old" RENAME TO "help_requests_type_enum"`,
    );
    await queryRunner.query(
