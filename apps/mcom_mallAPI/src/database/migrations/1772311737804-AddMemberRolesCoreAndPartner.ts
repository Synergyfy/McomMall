...
export class AddMemberRolesCoreAndPartner1772311737804 implements MigrationInterface {
  name = 'AddMemberRolesCoreAndPartner1772311737804';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."group_members_role_enum" RENAME TO "group_members_role_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."group_members_role_enum" AS ENUM('OWNER', 'ADMIN', 'MEMBER', 'BANKER', 'GUEST', 'PERIPHERAL', 'CORE', 'PARTNER')`,
    );
    await queryRunner.query(
      `ALTER TABLE "group_members" ALTER COLUMN "role" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "group_members" ALTER COLUMN "role" TYPE "public"."group_members_role_enum" USING "role"::"text"::"public"."group_members_role_enum"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."group_members_role_enum_old" AS ENUM('ADMIN', 'BANKER', 'GUEST', 'MEMBER', 'OWNER', 'PERIPHERAL')`,
    );
    await queryRunner.query(
      `ALTER TABLE "group_members" ALTER COLUMN "role" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "group_members" ALTER COLUMN "role" TYPE "public"."group_members_role_enum_old" USING "role"::"text"::"public"."group_members_role_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "group_members" ALTER COLUMN "role" SET DEFAULT 'MEMBER'`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."group_members_role_enum_old" RENAME TO "group_members_role_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
