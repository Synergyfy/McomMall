...
export class AddTierTypeAndTrialDuration1771161564351 implements MigrationInterface {
  name = 'AddTierTypeAndTrialDuration1771161564351';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tiers_type_enum" AS ENUM('STANDARD', 'TRIAL')`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ADD "type" "public"."tiers_type_enum" NOT NULL DEFAULT 'STANDARD'`,
    );
    await queryRunner.query(`ALTER TABLE "tiers" ADD "trialDuration" integer`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "tiers" DROP COLUMN "trialDuration"`);
    await queryRunner.query(`ALTER TABLE "tiers" DROP COLUMN "type"`);
    await queryRunner.query(`DROP TYPE "public"."tiers_type_enum"`);
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
    await queryRunner.query(
