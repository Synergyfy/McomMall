...
export class AddIsDefaultToTier1770648338729 implements MigrationInterface {
  name = 'AddIsDefaultToTier1770648338729';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tiers" ADD "isDefault" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "tiers" DROP COLUMN "isDefault"`);
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
    await queryRunner.query(
