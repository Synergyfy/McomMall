...
export class AddMessageToPartnershipRequest1770731486890 implements MigrationInterface {
  name = 'AddMessageToPartnershipRequest1770731486890';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_partnership_requests" ADD "message" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "item_partnership_requests" ADD "message" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "item_partnership_requests" DROP COLUMN "message"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_partnership_requests" DROP COLUMN "message"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
