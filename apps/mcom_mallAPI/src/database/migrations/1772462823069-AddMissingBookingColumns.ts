...
export class AddMissingBookingColumns1772462823069 implements MigrationInterface {
  name = 'AddMissingBookingColumns1772462823069';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "variantId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "tierId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "quantity" integer NOT NULL DEFAULT '1'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "quantity"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "tierId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "variantId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
