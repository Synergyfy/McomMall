...
export class MarketplaceSchema1768864499130 implements MigrationInterface {
  name = 'MarketplaceSchema1768864499130';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "marketplace_sections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "type" character varying NOT NULL, "title" character varying NOT NULL, "isVisible" boolean NOT NULL DEFAULT true, "config" jsonb, "productIds" text, CONSTRAINT "UQ_f7885f24803aab22363f70cdcab" UNIQUE ("type"), CONSTRAINT "PK_b745e5e1a1c9dc976879fb7dad9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "marketplace_categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "iconName" character varying, "targetCategoryId" character varying, "displayOrder" integer NOT NULL DEFAULT '0', "isVisible" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_ccbec861df6ee237ddbe895c6d2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."marketplace_banners_type_enum" AS ENUM('hero_slide', 'sidebar_banner')`,
    );
    await queryRunner.query(
      `CREATE TABLE "marketplace_banners" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "imageUrl" character varying NOT NULL, "title" character varying, "linkUrl" character varying, "type" "public"."marketplace_banners_type_enum" NOT NULL DEFAULT 'hero_slide', "displayOrder" integer NOT NULL DEFAULT '0', "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_f1b151c9ccb384b1af332752b34" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "marketplace_banners"`);
    await queryRunner.query(
      `DROP TYPE "public"."marketplace_banners_type_enum"`,
    );
    await queryRunner.query(`DROP TABLE "marketplace_categories"`);
    await queryRunner.query(`DROP TABLE "marketplace_sections"`);
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" ADD CONSTRAINT "FK_f143f396ea55404f8ed5a5421a3" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
