...
export class AddBookingConfigFields1772384417512 implements MigrationInterface {
  name = 'AddBookingConfigFields1772384417512';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "address" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "phone" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "problemDescription" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "photos" jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "config" jsonb`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "config"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "photos"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "problemDescription"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "phone"`,
    );
    await queryRunner.query(
