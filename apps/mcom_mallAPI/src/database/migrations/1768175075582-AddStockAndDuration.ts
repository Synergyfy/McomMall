...
export class AddStockAndDuration1768175075582 implements MigrationInterface {
  name = 'AddStockAndDuration1768175075582';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "services" ADD "duration" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
