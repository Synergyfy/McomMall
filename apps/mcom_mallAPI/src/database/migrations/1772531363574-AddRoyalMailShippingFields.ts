...
export class AddRoyalMailShippingFields1772531363574 implements MigrationInterface {
  name = 'AddRoyalMailShippingFields1772531363574';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "royalMailShipmentId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "royalMailLabelData" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD "shippingAddressId" uuid`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "royalMailLabelData"`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" DROP COLUMN "royalMailShipmentId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
