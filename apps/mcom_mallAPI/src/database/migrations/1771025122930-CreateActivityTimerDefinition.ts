...
export class CreateActivityTimerDefinition1771025122930 implements MigrationInterface {
  name = 'CreateActivityTimerDefinition1771025122930';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."activity_timer_definitions_type_enum" AS ENUM('TRIAL', 'GENERAL')`,
    );
    await queryRunner.query(
      `CREATE TABLE "activity_timer_definitions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" text, "type" "public"."activity_timer_definitions_type_enum" NOT NULL DEFAULT 'GENERAL', "key" character varying NOT NULL, "actionUrl" character varying, "targetTierIds" text, "durationDays" integer, "expiresAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4bf7afc42259839382ffdfc9acc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "activity_timer_definitions"`);
    await queryRunner.query(
      `DROP TYPE "public"."activity_timer_definitions_type_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" ADD CONSTRAINT "FK_f143f396ea55404f8ed5a5421a3" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
