...
export class AddBusinessRatingFields1772466346142 implements MigrationInterface {
  name = 'AddBusinessRatingFields1772466346142';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD "averageRating" double precision NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" ADD "reviewCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP COLUMN "reviewCount"`,
    );
    await queryRunner.query(
      `ALTER TABLE "businesses" DROP COLUMN "averageRating"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
