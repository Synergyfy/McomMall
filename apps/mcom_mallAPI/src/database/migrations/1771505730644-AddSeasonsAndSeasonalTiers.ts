...
export class AddSeasonsAndSeasonalTiers1771505730644 implements MigrationInterface {
  name = 'AddSeasonsAndSeasonalTiers1771505730644';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "seasons" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "description" text, "image" character varying, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, CONSTRAINT "PK_cb8ed53b5fe109dcd4a4449ec9d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "tiers" ADD "season_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "memberships" ADD "startDate" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "memberships" ADD "endDate" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."tiers_type_enum" RENAME TO "tiers_type_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tiers_type_enum" AS ENUM('STANDARD', 'TRIAL', 'SEASONAL')`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ALTER COLUMN "type" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ALTER COLUMN "type" TYPE "public"."tiers_type_enum" USING "type"::"text"::"public"."tiers_type_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ALTER COLUMN "type" SET DEFAULT 'STANDARD'`,
    );
    await queryRunner.query(`DROP TYPE "public"."tiers_type_enum_old"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tiers" ADD CONSTRAINT "FK_b29f3abd2fb00286f8e2196fe46" FOREIGN KEY ("season_id") REFERENCES "seasons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tiers" DROP CONSTRAINT "FK_b29f3abd2fb00286f8e2196fe46"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_81d38487c29d69bf340eead614c"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tiers_type_enum_old" AS ENUM('STANDARD', 'TRIAL')`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ALTER COLUMN "type" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ALTER COLUMN "type" TYPE "public"."tiers_type_enum_old" USING "type"::"text"::"public"."tiers_type_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tiers" ALTER COLUMN "type" SET DEFAULT 'STANDARD'`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."tiers_type_enum_old" RENAME TO "tiers_type_enum"`,
    );
    await queryRunner.query(`ALTER TABLE "memberships" DROP COLUMN "endDate"`);
    await queryRunner.query(
      `ALTER TABLE "memberships" DROP COLUMN "startDate"`,
    );
    await queryRunner.query(`ALTER TABLE "tiers" DROP COLUMN "season_id"`);
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
    await queryRunner.query(
