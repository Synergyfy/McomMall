...
export class UpdateItemPartnershipRequest1770717856389 implements MigrationInterface {
  name = 'UpdateItemPartnershipRequest1770717856389';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "item_partnership_requests" ADD "receiverId" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "item_partnership_requests" ADD CONSTRAINT "FK_820d6ec0c1d43d36910aca51186" FOREIGN KEY ("receiverId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "item_partnership_requests" DROP CONSTRAINT "FK_820d6ec0c1d43d36910aca51186"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_f143f396ea55404f8ed5a5421a3"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "item_partnership_requests" DROP COLUMN "receiverId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
