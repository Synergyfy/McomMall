...
export class CreateTaxonomyTables1768491438510 implements MigrationInterface {
  name = 'CreateTaxonomyTables1768491438510';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "sectors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "image" character varying, "description" character varying, CONSTRAINT "UQ_1a10b192342e5165948f4dccefc" UNIQUE ("name"), CONSTRAINT "PK_923fdda0dc12f59add7b3a1782f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "taxonomy_categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "image" character varying, "description" character varying, "sectorId" uuid NOT NULL, CONSTRAINT "UQ_52af5969dc4b46a59d531a40a99" UNIQUE ("name"), CONSTRAINT "PK_75897618da1170448432cf2a8af" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "taxonomy_subcategories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "image" character varying, "description" character varying, "categoryId" uuid NOT NULL, CONSTRAINT "UQ_3f891eca12f85ed9589b047c3ce" UNIQUE ("name"), CONSTRAINT "PK_e747bd1bec78d611feed76fb7bd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."memberships_plantype_enum" AS ENUM('monthly', 'annual')`,
    );
    await queryRunner.query(
      `ALTER TABLE "memberships" ADD "planType" "public"."memberships_plantype_enum" NOT NULL DEFAULT 'monthly'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "memberships" ADD CONSTRAINT "FK_37fe23a8905d80cdc77ece23fda" FOREIGN KEY ("tier_id") REFERENCES "tiers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "taxonomy_categories" ADD CONSTRAINT "FK_d359a9266d55b10cf933b9bd6a7" FOREIGN KEY ("sectorId") REFERENCES "sectors"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "taxonomy_subcategories" ADD CONSTRAINT "FK_0d38df1bdd215b84ee85474c608" FOREIGN KEY ("categoryId") REFERENCES "taxonomy_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "taxonomy_subcategories" DROP CONSTRAINT "FK_0d38df1bdd215b84ee85474c608"`,
    );
    await queryRunner.query(
      `ALTER TABLE "taxonomy_categories" DROP CONSTRAINT "FK_d359a9266d55b10cf933b9bd6a7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "memberships" DROP CONSTRAINT "FK_37fe23a8905d80cdc77ece23fda"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "FK_81d38487c29d69bf340eead614c"`,
    );
    ...
    await queryRunner.query(`DROP TABLE "taxonomy_subcategories"`);
    await queryRunner.query(`DROP TABLE "taxonomy_categories"`);
