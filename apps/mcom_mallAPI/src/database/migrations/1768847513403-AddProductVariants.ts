...
export class AddProductVariants1768847513403 implements MigrationInterface {
  name = 'AddProductVariants1768847513403';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "Products" ADD "variantConfig" jsonb`);
    await queryRunner.query(
      `ALTER TABLE "order_items" ADD "selectedVariants" jsonb`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order_items" DROP COLUMN "selectedVariants"`,
    );
    await queryRunner.query(
      `ALTER TABLE "Products" DROP COLUMN "variantConfig"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
