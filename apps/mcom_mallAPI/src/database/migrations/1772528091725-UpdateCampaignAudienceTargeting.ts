...
export class UpdateCampaignAudienceTargeting1772528091725 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."campaign_cashbacks_targettype_enum" RENAME TO "campaign_cashbacks_targettype_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."campaign_cashbacks_targettype_enum" AS ENUM('CUSTOMER', 'BUSINESS', 'ALL', 'SPECIFIC_USERS')`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_cashbacks" ALTER COLUMN "targetType" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_cashbacks" ALTER COLUMN "targetType" TYPE "public"."campaign_cashbacks_targettype_enum" USING "targetType"::"text"::"public"."campaign_cashbacks_targettype_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_cashbacks" ALTER COLUMN "targetType" SET DEFAULT 'CUSTOMER'`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."campaign_cashbacks_targettype_enum_old"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."campaign_cashbacks_targettype_enum_old" AS ENUM('CONSUMERS', 'BUSINESS')`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_cashbacks" ALTER COLUMN "targetType" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_cashbacks" ALTER COLUMN "targetType" TYPE "public"."campaign_cashbacks_targettype_enum_old" USING "targetType"::"text"::"public"."campaign_cashbacks_targettype_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "campaign_cashbacks" ALTER COLUMN "targetType" SET DEFAULT 'CONSUMERS'`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."campaign_cashbacks_targettype_enum"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."campaign_cashbacks_targettype_enum_old" RENAME TO "campaign_cashbacks_targettype_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
