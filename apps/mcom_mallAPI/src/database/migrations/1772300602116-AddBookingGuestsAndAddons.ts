...
export class AddBookingGuestsAndAddons1772300602116 implements MigrationInterface {
  name = 'AddBookingGuestsAndAddons1772300602116';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "numberOfGuests" integer NOT NULL DEFAULT '1'`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" ADD "addonDetails" jsonb`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "addonDetails"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_bookings" DROP COLUMN "numberOfGuests"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_f143f396ea55404f8ed5a5421a3"`,
    );
