...
export class UpdateActivityTimerTiers1771194011573 implements MigrationInterface {
  name = 'UpdateActivityTimerTiers1771194011573';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "activity_timers" ADD "includedTierIds" text`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_timers" ADD "excludedTierIds" text`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "activity_timers" DROP COLUMN "excludedTierIds"`,
    );
    await queryRunner.query(
      `ALTER TABLE "activity_timers" DROP COLUMN "includedTierIds"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_provider_profiles" DROP CONSTRAINT "UQ_81d38487c29d69bf340eead614c"`,
    );
