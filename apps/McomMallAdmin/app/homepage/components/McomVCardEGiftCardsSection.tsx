        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-xl bg-white shadow-lg">
            <div className="relative h-60 w-full overflow-hidden bg-gray-200">
              <img src="https://images.unsplash.com/photo-1637070155805-e6fbee6ec2cf?q=80&w=1198&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Mockup of MCOMVCARD EGift Card on a phone" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="relative overflow-hidden rounded-xl bg-white shadow-lg">
            <div className="relative h-60 w-full overflow-hidden bg-gray-200">
              <img src="https://images.unsplash.com/photo-1585314062528-0c3742fa6102?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Graphical representation of accelerated growth" className="absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-black/20" />
            </div>
            <div className="p-6">
              <p className="text-sm font-semibold text-orange-600">
