...
export const mainMenuItems: MenuItem[] = [
  ...
  { title: 'All Bookings', href: '/dashboard/my-bookings', icon: Calendar },
...
export const productMenuItems: MenuItem[] = [
  ...
  { title: 'All Orders', href: '/dashboard/store/orders', icon: ShoppingBag },
];
...
export const adminMenuItems: MenuItem[] = [
  ...
  { title: 'User Management', href: '/admin/user-management', icon: UserPen },
  {
    title: 'All Listings',
    href: '/admin/all-listings',
    icon: List,
  },
  { title: 'All Bookings', href: '/admin/all-bookings', icon: Calendar },
  { title: 'All Services', href: '/admin/all-services', icon: SquareDashedKanban },
  { title: 'All Orders', href: '/admin/all-orders', icon: ShoppingCart },
  { title: 'All Products', href: '/admin/all-products', icon: ShoppingBag },
